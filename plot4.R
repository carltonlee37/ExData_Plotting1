...
with(power,plot(datetime,GlobalActivePower,type="l",xlab="",ylab="Global Active Power"))
...
with(power,plot(datetime,GlobalReactivePower,type="l",ylab="Global_reactive_power"))
dev.off()
